...
public class PharmacistController extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (id.isEmpty()) {
            ...
            /** 透過PharmacistHelper物件的getByID()方法自資料庫取回該名櫃台行政之資料，回傳之資料為JSONObject物件 */
            JSONObject query = pmh.getByID(id);
    ...
    public void doDelete(HttpServletRequest request, HttpServletResponse response)
        ...
        /** 透過PharmacistHelper物件的deleteByID()方法至資料庫刪除該名櫃台行政，回傳之資料為JSONObject物件 */
        JSONObject query = pmh.deleteByID(id);
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Pharmacist pm = new Pharmacist(id, account, password, name, dob, phone, address);

        /** 透過Pharmacist物件的update()方法至資料庫更新該名櫃台行政資料，回傳之資料為JSONObject物件 */
        JSONObject data = pm.update();
